...
{
   baseShape = "../shapes/Cryptid/DUMMYcellardoorNOANIM.cached.dts";
};

function DUMMYcellardoorNOANIM_cachedDts::onLoad(%this)
{
   %this.addSequence("../shapes/Cryptid/DUMMYcellardoor.dae", "Open", "0", "-1", "1", "0");
}

datablock StaticShapeData (cellarDoor)
{
   shapeFile = "../shapes/Cryptid/DUMMYcellardoorNOANIM.cached.dts";
   Unopened = true;
